...
func TestLoadRejectsInvalidConfiguration(t *testing.T) {
	tests := []struct {
		...
		{name: "invalid request timeout", key: "HTTP_REQUEST_TIMEOUT", value: "0s", wantError: "HTTP_REQUEST_TIMEOUT"},
		{name: "request timeout at the write timeout", key: "HTTP_REQUEST_TIMEOUT", value: "30s", wantError: "shorter than HTTP_WRITE_TIMEOUT"},
		...
		{name: "statement timeout beyond the request timeout", key: "DB_STATEMENT_TIMEOUT", value: "11s", wantError: "must not exceed HTTP_REQUEST_TIMEOUT"},
